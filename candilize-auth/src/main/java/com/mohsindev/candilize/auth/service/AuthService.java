...
import com.mohsindev.candilize.auth.infrastructure.persistence.entity.UserEntity;
...
public class AuthService {
    ...
    public AuthResponse login(LoginRequest request) {
        ...
        return AuthResponse.of(accessToken, refreshToken, accessTokenExpirationMs / 1000);
    }
    ...
    public AuthResponse refreshToken(String refreshToken) {
        ...
        return AuthResponse.of(newAccessToken, newRefreshToken, accessTokenExpirationMs / 1000);
    }
}
